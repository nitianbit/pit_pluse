...
export const COLORS = {
    ...
    SUB_TEXT:'#8E8E93',
    DARK_THEME_BACKGROUND_DARK_BLUE:'#090F29',
    DARK_THEME_BACKGROUND_LIGHT_BLUE:'#101835',
    LIGHT_THEME_BACKGROUND_DARK_BLUE:'#D2DCFF',
    LIGHT_THEME_BACKGROUND_LIGHT_BLUE:'#E8EDFF',
    LIGHT_THEME_SELECTED_DRIVER_COLOR:'#D2DCFF',
    LIGHT_THEME_UNSELECTED_DRIVER_COLOR:'#E8EDFF',
    DARK_THEME_SELECTED_DRIVER_COLOR:'#0D6EFD',
    DARK_THEME_UNSELECTED_DRIVER_COLOR:'#0A0F27',
}
...
export const lightTheme = {
  ...
  dark_blue:COLORS.LIGHT_THEME_BACKGROUND_DARK_BLUE,
  light_blue:COLORS.LIGHT_THEME_BACKGROUND_LIGHT_BLUE,
  selected_driver_fill_color:COLORS.LIGHT_THEME_SELECTED_DRIVER_COLOR,
  unselected_driver_fill_color:COLORS.LIGHT_THEME_UNSELECTED_DRIVER_COLOR,
};
...
export const darkTheme = {
  ...
  dark_blue:COLORS.DARK_THEME_BACKGROUND_DARK_BLUE,
  light_blue:COLORS.DARK_THEME_BACKGROUND_LIGHT_BLUE,
  selected_driver_fill_color:COLORS.DARK_THEME_SELECTED_DRIVER_COLOR,
  unselected_driver_fill_color:COLORS.DARK_THEME_UNSELECTED_DRIVER_COLOR,
};
